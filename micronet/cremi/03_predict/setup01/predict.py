...
def predict(
    ...
    run_dir = "/groups/funke/home/ecksteinn/Projects/microtubules/micronet/micronet/cremi/02_train/setup0{}/checkpoints/run_{}".format(setup, run)
    ...
    read_roi.snap_to_grid(input_shape)
